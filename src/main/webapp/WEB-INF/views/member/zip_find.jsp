...
<SCRIPT>
   ...
   function selectnow() {
      ...
      opener.document.m.m_addr.value = input_addr;
      /* 회원가입창에  주소를  입력한다. */

      opener.document.m.m_addr2.focus();
      //나머지 주소 입력창으로 포커스 이동
   ...
   <form method="post" action="zip_find_ok" name="postform" onsubmit="return check(this)">
      <table width="414" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
         <tr>
            ...
            <input type="image"src="/imgs/member/ZipCode_img01.gif" width="413" height="58"></td>
         </tr>
         <tr>
         ...
         <tr height="30">
            ...
            <input type="image" src="/imgs/member/m-i02.gif" width="69" height="19"
               align="absmiddle" onfocus="this.blur()">
