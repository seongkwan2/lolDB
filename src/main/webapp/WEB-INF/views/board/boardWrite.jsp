...
<body>
    ...
    <div class="board_con">
        ...
        <form id="boardForm" method="post">
            ...
            <input type="text" name="b_id" placeholder="작성자 아이디" required><br> <%--나중엔 여기에 readonly로 로그인정보를 삽입 --%>
            <input type="text" name="b_title" placeholder="글 제목" required><br>
            <textarea name="b_cont" placeholder="글 내용" rows="5" required></textarea><br>
